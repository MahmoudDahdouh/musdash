...
| Sidebar     | `.sidebar` `.nav-*`                                                    | Unchanged structure. Brand row gets the wordmark (6.4). Env rows get a 6px status dot when the nav data carries state (see 8, slice 3). A row under the foot holds the RSS instrument. Active item: `--surface-2` background and `--text`, a 2px `--ink` bar on the left edge instead of a blue tint.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
