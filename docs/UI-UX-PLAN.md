...
- Headings: `h1` 24/1.2 600 tight; `h2` 16/1.3 600; `h3` 14/1.4 600. **No
  ...
  until slice 5b replaced its last use with a `.kv`; it was removed.)
...
| 6   | **Settings**                | `settings.eta`, `app.css`, `src/routes/app.ts` (GET `/settings` only), this plan                                                                                                                                                        | Status strip at top. Notices toned per §7. Prose under `<details>`, cards ≤ `--prose-w`. Restart disabled with reason as hint. **Result:** strip, re-toned notices, `<details>`, `.card-prose` cards; the flash moved into the layout (one hunk in the GET handler). app.css 30,519 B, app.js unchanged.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | New settings                                                                                            |
